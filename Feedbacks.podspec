#
#  Be sure to run `pod spec lint Feedbacks.podspec' to ensure this is a
...
Feedbacks is an easy way to show UI/UX feedback.
  ...
  # Or just: spec.author    = "Kirill Budevich"
  # spec.authors            = { "Kirill Budevich" => "ikloo@yandex.ru" }
  # spec.social_media_url   = "https://twitter.com/Kirill Budevich"
  ...
  spec.source_files  = "Feedbacks/**/*.{h,m,swift}"
